...
class Table(models.Model):
    ...
    number_table = models.PositiveIntegerField(
        verbose_name="Номер столика", help_text="Введите номер столика", unique=True
    )
...
class Feedback(models.Model):
    user = models.ForeignKey(
        User, on_delete=models.SET_NULL, verbose_name="Гость", help_text="Укажите гостя", blank=True, null=True
    )
