...
from resto.views import (AboutUsTemplateView, ConfirmReservationView, FeedbackCreateView, FreeTablesView,
                         HomeTemplateView, MenuListView, PosterListView, ReservationCreateView, ReservationDeleteView,
                         ReservationUpdateView, TableSelectionTemplateView)
